    ...
    const handleClick = (val) => {
        ...
        if (counter === 0) {
            ...
            if (val) {// Si se da hacia adelante
                ...
                cards[counter].classList.toggle("slide-throw-left")// 

                cards[n].classList.toggle("card-slider-show")// 
            ...
            if (val) {// Si se da hacia adelante
                ...
                cards[n].classList.toggle("slide-throw-left")// 
                cards[0].classList.toggle("slide-throw-left")// 
                cards[n].classList.toggle("card-slider-show")// 
            }
        } else {
            ...
            if (val) {// Si se da hacia adelante
                ...
                cards[counter - 1].classList.toggle("slide-selected")// Selecciona la anterior carta
                cards[counter].classList.toggle("slide-throw-left")// 
                cards[counter + 1].classList.toggle("slide-throw-left")// 
            }
        }
    }
        ...
        <>
            <div className="slide">
                <div className="cont">
                    {
                        cantCards.map((unit) =>
                            <SliderCard key={unit} i={unit} n={n} />
                        )
                    }
                </div>
